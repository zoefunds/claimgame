...
Real, live testing against StudioNet — never mocks, never placeholder data — across every version from v0.3.0 through v0.3.6. Full narrative history (every bug found, every fix, every re-test) lives in [docs/genlayer.md](docs/genlayer.md); this section is the current summary.

**All 37 public methods have been exercised live** at least once, most repeatedly across versions:
